...
function swim(t, Vs, beta, Pe_r,kappa, Lx, Ly, dt)
...
# 		total internal reflection
		...
		master_sol_y[(active_particles .& (master_sol_y .< 0)) .&  (master_adhesion_rand .< kappa)] .=  - master_sol_y[(active_particles .& (master_sol_y .< 0)) .&  (master_adhesion_rand .< kappa)] 
		master_sol_theta[(active_particles .& (master_sol_y .< 0)) .&  (master_adhesion_rand .< kappa)] .= 	master_sol_theta[(active_particles .& (master_sol_y .< 0)) .&  (master_adhesion_rand .< kappa)] .- 2*pi
		...
		#master_sol_xb[(active_particles .& (master_sol_y .< 0)  ) .&  (master_adhesion_rand[active_particles .& (master_sol_y .<= 0)] .< adhesion_prob) ] =master_sol_x[active_particles .& (master_sol_y .<= 0) .&  (master_adhesion_rand[active_particles .& (master_sol_y .<= 0)] .< adhesion_prob) ]
	#	master_sol_tb[(active_particles .& (master_sol_y .< 0)  ) .&  (master_adhesion_rand[active_particles .& (master_sol_y .<= 0)] .= t

		# refill the spaces with new random numbers
	#	master_adhesion_rand[active_particles .& (master_sol_y .<= 0)]=rand(length(master_sol_x[active_particles .& (master_sol_y .<= 0)]))
        master_adhesion_rand[(active_particles .& (master_sol_y .< 0)) .&  (master_adhesion_rand .< kappa)] .=   rand(length(master_sol_y[(active_particles .& (master_sol_y .< 0)) .&  (master_adhesion_rand .< kappa)]))
...
swim(t,Vs, beta, Pe_r,kappa, Lx, Ly, dt) # progress particles forwards
